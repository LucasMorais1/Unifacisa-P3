...
public class ArvoreBinariaComExpressaoAritmetica{
	/**
	 * M�todo que organiza uma equa��o aritm�tica em uma Arvore Bin�ria .
	 * @author Lucas Morais
	 * 
	...
	/**
	 * Criando �rvore bin�ria, a partir de uma equa��o.
	 * @param eq, equa��o que deseja transformar em uma �rvore;
	 */
...
//		char equa�ao = str.charAt(0);
// 		if (no == null) { // Arvore vazia
//			no = new No(str);
//			add = true; // condi��o para nao entrar no ultimo if
